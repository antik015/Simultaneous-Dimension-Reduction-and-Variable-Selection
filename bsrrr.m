function[C_post,C_mean,C_median,rank_estimate,C_processed]=bsrrr(Y,X,BURNIN=200,MCMC=1000,thin=1,r)
...
%%         rank_estimate= estimated rank of C %%
%%         C_processed= row and rank selected estimate of C %% 
...
[C_processed,MSE]=grouplasso(X,C_mean,C_median);
end
